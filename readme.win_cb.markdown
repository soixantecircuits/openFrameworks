...
## 0) Downloading openframeworks

- `git clone git@github.com:soixantecircuits/openFrameworks.git`
- download python : [python27](http://python.org/ftp/python/2.7.2/python-2.7.2.amd64.msi)
- download and install _pythontools_, follow this link : http://packages.python.org/an_example_pypi_project/setuptools.html
